...
const ONE_SHOT_HASH='37447b23e4ff1f6362b1bf6f721d282da840b2763e6c6347527f6380a898104a';
...
export async function GET(request:Request,{params}:{params:Promise<{path:string[]}>}){
  ...
  if(parts[0]==='one-shot'&&parts[1]){if(!secureEqual(parts[1],ONE_SHOT_HASH))return json({ok:false,code:'NOT_FOUND'},404);const started=await startSweep();return json({ok:true,state:'SWEEP_STARTED',...started,parallelism:50,commonCrawlPartitions:LANES.length,maxCandidatesPerLane:2,simulatedWorkersStarted:0},202);}
