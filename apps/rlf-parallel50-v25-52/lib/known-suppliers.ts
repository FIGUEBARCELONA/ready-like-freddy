...
export const KNOWN_REJECTED_DOMAINS=new Set([
  '2dehands.be','adverts.ie','annuaire-entreprises.data.gouv.fr','atticadps.gr','aukia.fi','bazar.bg','bstrongoutlet.pt','comparer.be','cybo.com','einforma.pt','elcorteingles.pt','entreprises.lefigaro.fr','espacemode.be','excelclothing.ie','factoryoutlet.gr','fashiola.com','fashiola.de','fashiola.fr','footshop.hu','footshop.sk','fratellirossishop.it','fredperryoutlet.de','fredperryoutletus.com','fredperryus.com','fredsperryonlineshop.de','gem.app','goldenpages.ie','headlock.co','index.hr','inno.be','jame.pt','jofogas.hu','joinfleek.com','kingpinclothingstore.com','kuantokusta.pt','kurpirkt.lv','ladc.be','laredoute.fr','loopi.com','mainlinemenswear.com','mapcarta.com','milanuncios.com','miravia.es','near-place.com','nextdirect.com','novacircle.com','olondon.fr','one4all.mt','outletaholic.com','pagesjaunes.fr','pagesmode.com','pappers.fr','pointcarre.be','rebirthofcool.ie','rihu.pt','roundrobinclassics.com','segunda-mano.pro','seitcheck.de','shop.maniet.be','showroom.pl','sprzedajemy.pl','stockholmfashiondistrict.se','stockverkopen.nl','streetwear.sk','suitable.be','taobao.com','the-gentlemen-store.de','thegentlemensvault.nl','thelabelfinder.com','twintipuk.myshopify.com','validate.perfdrive.com','vatera.hu','vendora.bg','vintageclothingguides.com','web2.cylex.de','wikipedia.org','world.taobao.com','worthpoint.com','xtreme.pt','yellow.com.mt','yelp.com','zedstore.it'
]);
