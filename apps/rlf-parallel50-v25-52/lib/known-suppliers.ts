...
export const KNOWN_REJECTED_DOMAINS=new Set([
  '2dehands.be','adverts.ie','annuaire-entreprises.data.gouv.fr','bazar.bg','cybo.com','entreprises.lefigaro.fr','fashiola.com','fashiola.de','fashiola.fr','gem.app','goldenpages.ie','headlock.co','joinfleek.com','kingpinclothingstore.com','kuantokusta.pt','kurpirkt.lv','ladc.be','loopi.com','mainlinemenswear.com','mapcarta.com','near-place.com','novacircle.com','one4all.mt','pagesjaunes.fr','pagesmode.com','pappers.fr','roundrobinclassics.com','stockholmfashiondistrict.se','taobao.com','thelabelfinder.com','twintipuk.myshopify.com','vendora.bg','vintageclothingguides.com','wikipedia.org','world.taobao.com','worthpoint.com','yellow.com.mt','yelp.com'
]);
