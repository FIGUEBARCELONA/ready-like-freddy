...
export type CandidateStatus='QUALIFIED_PROVISIONAL'|'DUPLICATE_KNOWN'|'DUPLICATE_IDENTITY_IN_SWEEP'|'EVIDENCE_INCOMPLETE'|'REJECT_MARKETPLACE'|'REJECT_NOT_PRELOVED'|'REJECT_UK'|'REJECT_NON_EU'|'FETCH_FAILED';
...
export type Candidate={
  ...
  supplierEvidence:'READY_TO_REVIEW'|'DUPLICATE'|'INCOMPLETE';productEvidence:'DIRECT_PRODUCT_PROVISIONAL'|'SUPPLIER_EVIDENCE_ONLY';
  ...
  euEvidence:boolean;detectedCountryCode:string|null;countryBasis:string;laneCountryMatch:boolean;knownDuplicate:boolean;
