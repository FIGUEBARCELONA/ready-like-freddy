...
export const MARKETPLACES=[
  'ebay.','vinted.','wallapop.','depop.','etsy.','amazon.','facebook.com','instagram.com','pinterest.','reddit.com','youtube.com','tiktok.com','linktr.ee',
...
export const NEW_RETAIL=[
  ...
  'stockverkopen.nl','comparer.be','web2.cylex.de','validate.perfdrive.com','odjeca.hr','nextdirect.com','next.ie','next.pl','outletaholic.com',
];

export const UK_OPERATORS=['headlock.co','roundrobinclassics.com','mainlinemenswear.com','thrifted.com','freshmansarchive.com','messinahembry.com','brasshanger.co.uk','preworn.com','rokit.co.uk','ie.rokit.co.uk','vintagerecovery.co.uk','livefortweed.co.uk','vintage-folk.com','atomretro.com'];
...
export const NEGATIVE='-ebay -vinted -wallapop -depop -etsy -amazon -poshmark -subito -grailed -vestiaire -leboncoin -olx -marktplaats -2dehands -kleinanzeigen -catawiki -reddit -wikipedia -yelp -zalando -asos -farfetch -vendora -bazar -pappers -pagesjaunes -kuantokusta -kurpirkt -linktree -jolicloset -milanuncios -miravia -sprzedajemy -jofogas -vatera -showroom';
