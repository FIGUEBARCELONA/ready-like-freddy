...
const menuItems = [
  ...
  { icon: FileCheck2, label: "Libros canónicos", path: "/imports" },
  { icon: Camera, label: "Visor forense", path: "/visual" },
  { icon: SlidersHorizontal, label: "Calibración", path: "/calibration" },
  { icon: ScrollText, label: "Auditoría", path: "/audit" },
];
              ...
              <div className="flex items-center gap-3">
                <div className="flex flex-col gap-1">
                  <span className="tracking-tight text-foreground">
                    {activeMenuItem?.label ?? "RLF Control"}
                  </span>
                </div>
              </div>
            </div>
